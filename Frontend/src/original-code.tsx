...
const CourseForm: React.FC<{
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
        <div>
          ...
          <input
            type="text"
            id="courseCode"
            className="border border-gray-300 rounded-md px-3 py-2 font-poppins w-full focus:outline-none focus:ring-2 focus:ring-blue-500"
      ...
      <button
        type="submit"
        className="bg-green-600 hover:bg-green-700 text-white font-medium py-2 font-poppins px-4 rounded-md transition flex items-center gap-1"
      >
        <PlusIcon size={16} />
        Add Course
      </button>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mb-6">
            ...
            <div className="flex items-center gap-3">
              <input
                type="number"
                id="classSize"
                className="border border-gray-300 rounded-md px-3 py-2 font-poppins w-24 focus:outline-none focus:ring-2 focus:ring-blue-500"
                value={classSize}
          ...
          <div className="space-y-8">
            {semesters.map((semester) => (
              ...
              >
                <div className="bg-gray-100 px-4 py-3 font-poppins flex justify-between items-center border-b">
                ...
                <div className="p-4">
                  ...
                  {semester.courses.length > 0 && (
                    <div className="mt-6">
                      <h4 className="text-md font-poppins text-gray-700 mb-2">
                        Courses
                      </h4>
                      <div className="overflow-x-auto">
                        <table className="min-w-full divide-y divide-gray-200">
                          <thead className="bg-gray-50">
                            <tr>
                              <th className="px-4 py-3 font-poppins text-left text-xs text-gray-500 uppercase tracking-wider">
                                Cod
                              </th>
                              <th className="px-4 py-3 font-poppins text-left text-xs text-gray-500 uppercase tracking-wider">
                                Title
                              ...
                              <th className="px-4 py-3 font-poppins text-right text-xs text-gray-500 uppercase tracking-wider">
                                Action
                              </th>
                            </tr>
                          </thead>
                          <tbody className="bg-white divide-y divide-gray-200 font-poppins">
                            {semester.courses.map((course) => (
                              <tr key={course.id}>
                                <td className="px-4 py-2 font-poppins whitespace-nowrap text-sm text-gray-900">
                                  {course.code}
                                </td>
                                <td className="px-4 py-2 font-poppins whitespace-nowrap text-sm text-gray-700">
                                  {course.title}
                                </td>
                                <td className="px-4 py-2 font-poppins whitespace-nowrap text-sm text-gray-700">
                                  {course.creditUnits}
                                ...
                                <td className="px-4 py-2 font-poppins whitespace-nowrap text-right">
                                  <button
                                    onClick={() =>
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            <button
              onClick={addSemester}
              className="bg-gray-200 hover:bg-gray-300 text-gray-800 font-medium py-2 font-poppins px-4 rounded-md transition"
            >
              Add Another Semester
            </button>
            <button
              onClick={calculateResults}
              className="bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 font-poppins px-4 rounded-md transition"
          ...
          {cgpa !== null && rank !== null && degreeClass !== null && (
            <div className="mt-10 bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden">
              <div className="bg-blue-50 px-6 py-4 border-b border-blue-100">
                <h3 className="text-xl font-poppins font-semibold text-blue-800">
              ...
              <div className="p-6">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                  ...
                  <div className="bg-white p-4 rounded-lg border border-gray-200 shadow-sm">
                    ...
                    <p className="text-3xl font-bold font-poppins text-indigo-600">
                      {rank}/{classSize}
                    </p>
                    <p className="text-sm font-poppins text-gray-500 mt-1">
                  ...
                  <div className="bg-white  p-4 rounded-lg border border-gray-200 shadow-sm">
                    ...
                    <p className="text-xl font-poppins font-bold text-green-600">
                      {degreeClass}
                    </p>
                    <p className="text-sm font-poppins text-gray-500 mt-1">
                ...
                <div className="mt-8 bg-gray-50 p-4 rounded-lg border border-gray-200">
                  ...
                  <ul className="list-disc list-inside space-y-1 text-gray-700">
                    {cgpa < 2.0 && (
                      <li className="font-poppins text-red-600">
