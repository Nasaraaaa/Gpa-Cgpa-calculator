...
import { TrophyIcon, AwardIcon, BarChartIcon, TrendingUpIcon } from 'lucide-react';
...
export const ResultsDisplay: React.FC<ResultsDisplayProps> = ({
  ...
  return <div className="mt-10 bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-white p-4 rounded-lg border border-gray-200 shadow-sm">
            <div className="flex items-center justify-between mb-4">
              <h4 className="text-gray-600 font-medium">Cumulative GPA</h4>
              <BarChartIcon className="text-blue-500" size={20} />
            </div>
            <p className={`text-3xl font-bold ${getCgpaColor()}`}>
              {cgpa.toFixed(2)}
            </p>
            <p className="text-sm text-gray-500 mt-1">out of 5.00 maximum</p>
          </div>
          {/* Class Rank Card */}
          <div className="bg-white p-4 rounded-lg border border-gray-200 shadow-sm">
            <div className="flex items-center justify-between mb-4">
          ...
          <div className="bg-white p-4 rounded-lg border border-gray-200 shadow-sm">
            <div className="flex items-center justify-between mb-4">
              <h4 className="text-gray-600 font-medium">Degree Class</h4>
